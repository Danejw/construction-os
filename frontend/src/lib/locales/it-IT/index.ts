...
const itITTranslations = {
  ...
  "projects": {
    ...
    "reviewFactsRunning": "Reviewing…",
    "reviewStatusPassed": "Facts checked",
    "reviewStatusNeedsReview": "Needs review",
    "reviewStatusFailed": "Review failed",
    "reviewStatusStale": "Review stale",
    "reviewFindingsTitle": "Factual review",
    "reviewApplyFix": "Apply fix",
    "reviewApplyAll": "Apply all fixes",
    "reviewApplyConfirm": "Apply selected suggested fixes to this artifact?",
    "reviewIngestWarnTitle": "Artifact needs review",
    "reviewIngestWarnBody": "The latest factual review found issues. Ingest as source anyway?",
    "reviewIngestWarnConfirm": "Ingest anyway",
    "reviewNoFixes": "No suggested fixes for the selected findings",
    "reviewSourceFindings": "Sources",
    "reviewMemoryFindings": "Project memory",
    "export": "Esporta",
    "exportPdf": "PDF",
...
export const itIT = fillMissingKeys(enUS, itITTranslations)
